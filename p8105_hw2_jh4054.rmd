...
1. There are 404 distinct locations
2. There are 50 states and the District of Columbia representated
3. NJ was the most observed state
4. In 2002, the median proportion of "excellent" responses across all surveyed counties is 23.60

```{r, collapse=TRUE}
#1. number of unique locations in dataset
brfss %>% 
